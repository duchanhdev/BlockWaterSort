...
public static class GleyNotifications
{
...
#if EnableNotificationsAndroid
    /// <summary>
    /// Request permission, updated for Android 13
    /// </summary>
    /// <param name="CompleteMethod"> callback method invoked when the user responds to the permission request.</param>
    public static void RequestPermision(UnityAction<PermissionStatus> CompleteMethod)
    {
        NotificationManager.Instance.RequestPermision(CompleteMethod);
    }
    ...
    {
        return NotificationManager.Instance.IsPermissionGranted();
    }
#endif
}