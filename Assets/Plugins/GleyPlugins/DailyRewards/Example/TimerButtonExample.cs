...
public class TimerButtonExample : MonoBehaviour
{
    ...
    public void ResetTimer()
    {
        ...
        GleyDailyRewards.TimerButton.ResetTimer(0);
    }
    ...
    public void AddTime()
    {
        ...
        GleyDailyRewards.TimerButton.AddTime(0, new TimeSpan(0, 1, 0));
    }
    ...
    public void RemoveTime()
    {
        ...
        GleyDailyRewards.TimerButton.RemoveTime(0, new TimeSpan(0, 1, 0));
    }
}