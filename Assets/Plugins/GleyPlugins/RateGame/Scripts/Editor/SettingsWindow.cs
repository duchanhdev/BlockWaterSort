namespace GleyRateGame
{
    ...
    {
        private const string FOLDER_NAME = "RateGame";
        ...
        private void OnGUI()
        {
            ...
            {
                EditorSceneManager.OpenScene($"{rootFolder}/Example/TestScene.unity");
            }
        ...
        private void CreateAdSettings()
        {
            ...
            AssetDatabase.CreateAsset(asset, $"{rootFolder}/Resources/RateGameSettingsData.asset");
