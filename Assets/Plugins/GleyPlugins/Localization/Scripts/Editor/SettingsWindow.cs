namespace GleyLocalization
{
    ...
    public class SettingsWindow : EditorWindow
    {
        ...
        private void CreateDailyRewardsSettings()
        {
            ...
            AssetDatabase.CreateAsset(asset, $"{rootFolder}/Resources/LocalizationSettingsData.asset");
        ...
        private void CreateSupportedLanguagesFile()
        {
            ...
            text += "}";
            File.WriteAllText($"{Application.dataPath}/{rootWithoutAssets}/Scripts/SupportedLanguages.cs", text);
            AssetDatabase.Refresh();
        }
        ...
        private void CreateWordIDsFile()
        {
            ...
            text += "}";
            File.WriteAllText($"{Application.dataPath}/{rootWithoutAssets}/Scripts/WordIDs.cs", text);
            AssetDatabase.Refresh();
        }
