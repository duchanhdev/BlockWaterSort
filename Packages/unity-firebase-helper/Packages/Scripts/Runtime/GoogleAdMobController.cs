...
namespace FirebaseHelper.Runtime
{
    public sealed class GoogleAdMobController : Singleton<GoogleAdMobController>
    {
        ...
        /// <summary>
        /// </summary>
        /// <param name="adSize">Will use full width ads if null</param>
        public void RequestBannerAd([CanBeNull] AdSize adSize = null)
        {
            PrintStatus("Requesting Banner ad.");

            // These ad units are configured to always serve test ads.
            var adUnitId = adsID.GetBannerAdsId();

            // Clean up banner before reusing
            bannerView?.Destroy();

            // Create a 320x50 banner at top of the screen
            bannerView = new BannerView(adUnitId, adSize ?? AdSize.GetPortraitAnchoredAdaptiveBannerAdSizeWithWidth(
                    AdSize
                        .FullWidth),
                AdPosition.Bottom);
            ...
            {
                var msg =
                    $"Banner ad received a paid event. (currency: {args.AdValue.CurrencyCode}, value: {args.AdValue.Value}";
                PrintStatus(msg);
            };
        ...
        public void RequestAndLoadInterstitialAd()
        {
            ...
            var adUnitId = adsID.GetInterstitialAdsId();
            ...
            {
                var msg =
                    $"Interstitial ad received a paid event. (currency: {args.AdValue.CurrencyCode}, value: {args.AdValue.Value}";
                PrintStatus(msg);
            };
        ...
        public void RequestAndLoadRewardedAd()
        {
            ...
            var adUnitId = adsID.GetRewardedAdsId();
            ...
            {
                var msg =
                    $"Rewarded ad received a paid event. (currency: {args.AdValue.CurrencyCode}, value: {args.AdValue.Value}";
                PrintStatus(msg);
            };
        ...
        public void RequestAndLoadAppOpenAd()
        {
            ...
            var adUnitId = adsID.GetAppopenAdsId();
        ...
        public void ShowAppOpenAd()
        {
            ...
            {
                var msg =
                    $"App Open ad received a paid event. (currency: {args.AdValue.CurrencyCode}, value: {args.AdValue.Value}";
                PrintStatus(msg);
            };
