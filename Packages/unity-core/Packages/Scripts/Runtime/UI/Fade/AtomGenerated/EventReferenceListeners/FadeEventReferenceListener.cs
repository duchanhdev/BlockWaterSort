using Egitech.Core.Runtime.UI.Fade.AtomGenerated.EventReferences;
using Egitech.Core.Runtime.UI.Fade.AtomGenerated.Events;
using Egitech.Core.Runtime.UI.Fade.AtomGenerated.UnityEvents;
using UnityAtoms;
using UnityEngine;

namespace Egitech.Core.Runtime.UI.Fade.AtomGenerated.EventReferenceListeners
{
    /// <summary>
