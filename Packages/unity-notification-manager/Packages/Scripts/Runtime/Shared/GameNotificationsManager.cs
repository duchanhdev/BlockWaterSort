...
#if UNITY_ANDROID
using NotificationManager.Runtime.Android;
using Unity.Notifications.Android;
#endif
using NotificationManager.Runtime.Core;
using UnityEngine;
#if UNITY_IOS
using FirebaseHelper.Runtime.Notification.iOS;
#endif

namespace NotificationManager.Runtime.Shared
{
    /// <summary>
    ...
    public class GameNotificationsManager : MonoBehaviour
    {
        ...
        public enum OperatingMode
        {
            ...
            /// <summary>
            ///     After clearing events, will put future ones back into the queue if they are marked with
            ///     <see cref="PendingNotification.Reschedule" />.
            /// </summary>
            /// <remarks>
        ...
        public async UniTask Initialize(params GameNotificationChannel[] channels)
        {
            if (Initialized)
            {
