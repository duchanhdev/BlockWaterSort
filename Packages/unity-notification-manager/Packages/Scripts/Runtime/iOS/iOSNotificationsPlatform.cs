...
namespace FirebaseHelper.Runtime.Notification.iOS
{
    ...
    public class iOSNotificationsPlatform : IGameNotificationsPlatform<iOSGameNotification>, IDisposable
    {
        ...
        public async UniTask RequestNotificationPermission()
        {
            using var request =
                new AuthorizationRequest(
                    AuthorizationOption.Badge | AuthorizationOption.Sound | AuthorizationOption.Alert, false);
        ...
        public void ScheduleNotification(IGameNotification gameNotification)
        {
            ...
            if (gameNotification is not iOSGameNotification notification)
            {
        ...
        public iOSGameNotification GetLastNotification()
        {
            ...
            return notification != null ? new iOSGameNotification(notification) : null;
        }
