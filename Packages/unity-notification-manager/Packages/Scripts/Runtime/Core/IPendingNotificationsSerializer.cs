...
namespace NotificationManager.Runtime.Core
{
    /// <summary>
    ///     Responsible for the serialization and deserialization of pending notifications for a
    ///     <see cref="GameNotificationsManager" /> that is in
    ///     <see
    ///         cref="GameNotificationsManager.OperatingMode.RescheduleAfterClearing" />
    ///     mode.
    /// </summary>
